...
use App\Services\HumanCapital\Actions\{WageService, DenyActionService};

class Wage extends ComponentAction
{
    public $actionRequest;

    public function approve() {
        $this->response((new WageService)->execute($this->actionRequest));
        $this->closeAction();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.human-capital.actions.wage', compact('action'));
    }
}
