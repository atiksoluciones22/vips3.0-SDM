...
use App\Services\HumanCapital\Actions\{LicenseService, DenyActionService};

class License extends ComponentAction
{
    public $actionRequest;

    public function approve() {
        $this->response((new LicenseService)->execute($this->actionRequest));
        $this->closeAction();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.human-capital.actions.license', compact('action'));
    }
}
