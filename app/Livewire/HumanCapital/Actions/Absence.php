...
use App\Services\HumanCapital\Actions\{AbsenceService, DenyActionService};

class Absence extends ComponentAction
{
    public $actionRequest;

    public function approve() {
        $this->response((new AbsenceService)->execute($this->actionRequest));
        $this->closeAction();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.human-capital.actions.absence', compact('action'));
    }
}
