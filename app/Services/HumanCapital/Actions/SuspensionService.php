...
class SuspensionService
{
    ...
    public function execute($request)
    {
        try {
            ...
            $data = $this->RequestService->getActionData($request, ['TIPINT' => \TypeActions::SUSPENSION->value]);
    ...
    {
        $this->MailService->sendResponsible(request: $request, subject: 'Suspensión', message: 'message...');
        $this->MailService->sendEmployee(request: $request, subject: 'Suspensión', message: 'message...');
    }
}
