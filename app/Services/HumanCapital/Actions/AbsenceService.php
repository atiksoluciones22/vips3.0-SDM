...
class AbsenceService
{
    ...
    public function execute($request)
    {
        try {
            ...
            $data = $this->RequestService->getActionData($request, ['TIPINT' => \TypeActions::ABSENCE->value]);
    ...
    {
        $this->MailService->sendResponsible(request: $request, subject: 'Ausencia', message: 'message...');
        $this->MailService->sendEmployee(request: $request, subject: 'Ausencia', message: 'message...');
    }
}
